<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seat_selection.aspx.cs" Inherits="Movie.seat_selection.Seat_selection" %>
		...
		<div class="demo">
			...
			<div class="booking-details">
				...
				<ul class="book-right">
					...
					<%--<li>:<asp:Label ID="lb1" runat="server"/></li>--%>
					
					<li>
						<asp:Textbox id="bookArrival" runat="server" textMode="Date" min="2023-11-02" max="2023-11-30"  required />
					</li>
					<li>
